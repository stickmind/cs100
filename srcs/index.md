...
本文档是《[CS61A：Structure and Interpretation of Computer Programs](https://cs61a.org/)》课程伴侣，整理该文档的目的是为了方便国内计算机编程爱好者学习相关内容。
...
课程的目标不是将大部分精力花费在编程语言的学习上，而是学习编程相关的概念。掌握一门特定的编程语言，仅仅是本课程的副作用。一旦你掌握了编程的概念，学习另一门新的编程语言将会变得非常容易。